...
*** 习题2.65
并集比较简单,直接利用tree->list转化成list以后append,再利用list->tree转化回来即可
#+BEGIN_SRC scheme
(define (union-set-tree tree1 tree2)
  (list->tree (append (tree->list tree1) (tree->list tree2))))
#+END_SRC
交集先利用tree->list把一个tree转化成list, 然后利用前面的adjoin-set方法把元素逐个插入第二个tree中.
#+BEGIN_SRC scheme
...
测试
#+BEGIN_SRC scheme
(union-set-tree (list->tree '(1 3 5)) (list->tree '(2)))
;Value 606: (3 (1 () ()) (5 () (2 () ())))

(intersection-set-tree (list->tree '(1 3 5)) (list->tree '(1 3 5 9 7 11)))
;Value 605: ((1 () (3 () ())) (5 () ()) ((7 (9 () ()) (11 () ())) () ()))
#+END_SRC
